...
# Model x2y2:
# This model assumes a linear relationship but it is actually cruvilinear.

# Model x3y3:
# This model has an outlier

# Model x4y4:
# This model has a single data point that influences the slope.
