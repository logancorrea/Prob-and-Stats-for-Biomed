...
# I found the skewness function, which is part of the e1071 library, to be useful for discriminating these 12 datasets. The skewness for these datasets varies between each set.
